...
class BuildTheFilesWeNeed(object):
    ...
    def __init__(self):
        self.sDocDir = 'static\\documents'
        self.sDocIndexFile = 'static\\docIDs.txt'
        self.sWordIndexFile = 'static\\wordIndex.txt'
        self.sTermFrequencyFile = 'static\\termFrequency.txt'
        self.sVectorFile = 'static\\tfIdfVectors.txt'
        self.sBasisWordsFile = 'static\\basisWords.txt'
